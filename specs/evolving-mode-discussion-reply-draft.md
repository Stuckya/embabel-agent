...
> **Status: historical discussion artifact.** This reply predates the baseline
> tests and maintainer discussion in issue #1756 that established existing
> fact-driven goal discovery. The current Phase 1 proposal adds episode
> lifecycle through `ProcessOptions`, without requiring a new invocation type.
> This reply is preserved for conversation history, not as the current design.
> See `evolving-mode-github-issue-draft.md`.
...
>
> ```text
> action output or external publish
>   -> runtime fact
>   -> evolution policy
